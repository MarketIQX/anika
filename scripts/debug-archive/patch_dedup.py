...
module = """\"\"\"Duplicate-rule judge — decides if a proposed meta-rule duplicates an existing one.
...
Path("app/agents/duplicate_judge.py").write_text(module, encoding="utf-8")
print("Wrote app/agents/duplicate_judge.py")

# Smoke test
import sys
sys.path.insert(0, ".")
from app.agents import duplicate_judge
print()
print("Module imports OK")
print(f"DuplicateJudgment fields: {list(duplicate_judge.DuplicateJudgment.model_fields.keys())}")
