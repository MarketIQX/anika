...
module = """\"\"\"Purpose-classifier agent — analyzes uploaded content and proposes a purpose.
...
Path("app/agents/purpose_classifier.py").write_text(module, encoding="utf-8")
print("Wrote app/agents/purpose_classifier.py")

# Quick import test
import sys
sys.path.insert(0, ".")
from app.agents import purpose_classifier
print()
print("Module imports OK")
print(f"Valid purposes: {purpose_classifier.VALID_PURPOSES}")
print(f"PurposeProposal fields: {list(purpose_classifier.PurposeProposal.model_fields.keys())}")
