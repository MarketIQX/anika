...
module = """\"\"\"Meta-rule generator — takes a user correction and proposes a generalizable rule.
...
Path("app/agents/meta_rule_generator.py").write_text(module, encoding="utf-8")
print("Wrote app/agents/meta_rule_generator.py")

# Smoke test
import sys
sys.path.insert(0, ".")
from app.agents import meta_rule_generator
print()
print("Module imports OK")
print(f"MetaRuleProposal fields: {list(meta_rule_generator.MetaRuleProposal.model_fields.keys())}")
